...
- **An embed this tool does not recognise** is one a sync never downloads and `verify` never
  ...
  any more: an embedded object, and a course file linked without NTULearn describing it, each
  leave a `> **Not copied**` line where they sat. Neither is counted; both are said.
