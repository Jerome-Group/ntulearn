...
const NOT_COVERED = [
  ...
  "`Last synced.md` and `Sync status.json` are records of the run rather than documents of the course, so a sync writes them and neither number counts them (docs/adr/0008, docs/adr/0015).",
];
