...
| Media workflow | Explicit media modes, RAID0 runtime/setup, Kaltura/YouTube/direct content-tree and Media Gallery discovery, durable queue handoff, provider adapters, pure media job, and artifact storage | `src/media/`, `npm run media:setup`, `npm run media:discover` |
